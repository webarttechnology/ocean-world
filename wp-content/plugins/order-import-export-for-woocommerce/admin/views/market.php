...
<div class="wt-import-export-upsell-wrapper market-box table-box-main">
    <div class="ier-premium-upgrade wt-ierpro-sidebar">
		...
		<div class="ier_pro_plugins_section_small">
			...
			<div class="wt-import-export-upsell-small-wrapper market-box table-box-main wt-ier-advt-order wt-ier-advt-coupon wt-ier-advt-subscription">
				<div class="ier-premium-upgrade wt-ierpro-sidebar">
					<div class="wt-ierpro-header">
						...
						<div class="wt-hide-features-view-plugin">
							...
							<div style="float:right;">
								<a class="wt-view-plugin" target="_blank" href="<?php echo esc_url("https://www.webtoffee.com/product/order-import-export-plugin-for-woocommerce/?utm_source=free_plugin_revamp&utm_medium=basic_revamp&utm_campaign=Order_Import_Export&utm_content=" . WT_O_IEW_VERSION); ?>"><?php _e('View plugin'); ?> <span style="font-size: 18px;" class="dashicons dashicons-arrow-right-alt"></span></a>				
							</div>
						</div>				
				...
				<div class="ier-premium-upgrade wt-ierpro-sidebar">
					<div class="wt-ierpro-header">
						...
						<div class="wt-hide-features-view-plugin">
							...
							<div style="float:right;">
								<a class="wt-view-plugin" href="<?php echo esc_url("https://www.webtoffee.com/product/product-import-export-woocommerce/?utm_source=free_plugin_revamp&utm_medium=basic_revamp&utm_campaign=Product_Import_Export&utm_content=" . WT_O_IEW_VERSION); ?>"><?php _e('View plugin'); ?> <span style="font-size: 18px;" class="dashicons dashicons-arrow-right-alt"></span></a>				
							</div>
						</div>
				...
				<div class="ier-premium-upgrade wt-ierpro-sidebar">
					<div class="wt-ierpro-header">
						...
						<div class="wt-hide-features-view-plugin">
							...
							<div style="float:right;">
								<a class="wt-view-plugin" href="<?php echo esc_url("https://www.webtoffee.com/product/wordpress-users-woocommerce-customers-import-export/?utm_source=free_plugin_revamp&utm_medium=basic_revamp&utm_campaign=User_Import_Export&utm_content=" . WT_O_IEW_VERSION); ?>"><?php _e('View plugin'); ?> <span style="font-size: 18px;" class="dashicons dashicons-arrow-right-alt"></span></a>				
							</div>
						</div>
